...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return buildMetadata({
    ...
    keywords: [...book.themes, book.title, "Jairo J. García libro"],
    path: `${staticRoutes.books.es}/${book.slug}`,
    alternatePath: bookAlternatePath(book.id as BookId, "en"),
  });
}
...
export default async function Page({ params }: Props) {
  ...
  return <BookDetailPage locale="es" site={site} book={book} />;
}
