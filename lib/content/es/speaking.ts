...
export const speaking: SpeakingContent = {
  ...
  inquiryForm: {
    ...
    successMessage:
      "¡Solicitud enviada! Te escribimos a tu correo para confirmar que la recibimos, y te contactaremos pronto con la disponibilidad y los detalles.",
    errorMessage: "Algo salió mal al enviar tu solicitud. Intenta de nuevo o escríbenos directamente a",
  },
